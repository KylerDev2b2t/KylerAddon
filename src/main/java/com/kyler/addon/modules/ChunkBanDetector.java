...
public class ChunkBanDetector extends Module {
    ...
    public ChunkBanDetector() {
        super(KylerAddon.CATEGORY, "chunk-ban-detector", "Warns of potential chunk ban exploits.");
    }
    ...
    private void onChunkData(ChunkDataEvent event) {
        ...
        if (entityCount > entityThreshold.get()) {
            ...
            if (alertMode.get() == AlertMode.Chat) {
                mc.player.sendMessage(Text.of(warning));
            } else {
